...
public:
	...
	void MoverCarta(std::string jugador, int filaOrigin, int columnaOrigin, int filaNuevo, int columnaNuevo);
	void EliminarCarta(std::string jugador, int fila, int columna);
